    ...
    <div className='py-96 bg-hero-pattern bg-center bg-cover'>
        <div className='px-10 space-y-5'>
            <div className='flex flex-col items-center '>
                ...
                <h1 className='text-4xl md:text-6xl max-w-xl font-serif tracking-wider text-white'>Let's <span className='text-orange-600'>Fly</span> With <span className='text-orange-600'>Us</span></h1>
